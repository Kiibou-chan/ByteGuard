package space.kiibou.byteguard.processor
...
import space.kiibou.byteguard.processor.error.ReportException
import space.kiibou.byteguard.processor.info.*
import space.kiibou.byteguard.processor.util.ErrorReporter
...
import space.kiibou.byteguard.specification.method.MethodSpec as ByteGuardMethodSpec

@Suppress("UnstableApiUsage")
@AutoService(Processor::class)
@SupportedSourceVersion(SourceVersion.RELEASE_17)
@SupportedAnnotationTypes("space.kiibou.byteguard.annotation.SpecFor")
class SpecForProcessor : AbstractProcessor() {
    ...
    private fun processClassElement(element: TypeElement): ClassSpecificationInfo {
        ...
        val methodSpecs = getMethodsReturning(ByteGuardMethodSpec::class.java, element)
